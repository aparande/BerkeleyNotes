...
\begin{theorem}[Weak Law of Large Numbers]
  ...
  \label{thm:weak-law}
\end{theorem}
With these inequalities, we can formalize the intuition that we have which says probability is the frequency with which an even happens over many trials of an event.
