...
Together, equation -1 are known as **Phase Variable Form**. Notice that
the characteristic polynomial of the $$A$$ matrix when it is in phase
variable form is
...
half plane and use equation -1 to find $$Z$$. However, remember that we
