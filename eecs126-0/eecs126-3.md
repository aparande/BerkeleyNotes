...
\pr{X \geq a} \leq \frac{\expect{e\^{tX}}}{e\^{ta}} = e\^{-ta}M\_x\(t\).
...
{% hint style="info" %}
### Theorem 19 \(Strong Law of Large Numbers\) <a id="theorem-19"></a>
...
{% hint style="info" %}
### Theorem 20 \(Weak Law of Large Numbers\) <a id="theorem-20"></a>

Let $$X_1, X_2, \cdots, X_n$$ be independently and identically distributed according to $$X$$, and let $$M_n = \frac{1}{n}\sum X_i$$. Then for $$\epsilon > 0$$,
